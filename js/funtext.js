...
const CITIZEN_TEXTS = [
  ...
  // --- 25 تای جدید ---
  { text: "روز اول دهن بزرگ نکن، آبروریزیه", icon: "skull", color: "#f87171" },
  { text: "اگه کارآگاهی نتیجه‌تو شب تو خواب بگو", icon: "eye", color: "#60a5fa" },
  { text: "دکتری؟ خودتو سیو کنی خجالت‌آوره", icon: "shield", color: "#4ade80" },
  { text: "اون که از روز اول همه رو متهم میکنه... تویی", icon: "brain", color: "#a78bfa" },
  { text: "یه بار هم که شده مافیارو درست بشناس", icon: "star", color: "#fcd34d" },
  { text: "اگه ساکتی همه فکر میکنن نقشداری. حق دارن", icon: "ghost", color: "#94a3b8" },
  { text: "رأی خوردی؟ دفاع کن نه گریه", icon: "mask", color: "#fb923c" },
  { text: "روز آخر که موندی، دیگه قرار نیست نقشدار پیدا کنی", icon: "clock", color: "#fbbf24" },
  { text: "بهترین دوستت احتمالاً مافیاست. خب.", icon: "knife", color: "#f472b6" },
  { text: "اگه شب حذف شدی آروم برو بیرون", icon: "ghost", color: "#c084fc" },
  { text: "اون که زیادی میخنده... یا خوشحاله یا مافیاست", icon: "fire", color: "#fb7185" },
  { text: "اگه روز یک نقشدارو حذف کردین — نوش جونتون", icon: "bomb", color: "#ef4444" },
  { text: "کارآگاه بودن یعنی استعلام بدی نه اعلام کنی", icon: "brain", color: "#818cf8" },
  { text: "مافیا از صبح داره بهت نگاه میکنه. سلام!", icon: "eye", color: "#60d9fa" },
  { text: "اگه اعتراض داری داور هستی نه بازیکن", icon: "lightning", color: "#a78bfa" },
  { text: "شهروند خوب مافیارو پیدا میکنه نه رفیقشو", icon: "shield", color: "#34d399" },
  { text: "امشب که دکتر سیو کرد — تو نبودی. ولی بازم باحاله", icon: "star", color: "#fcd34d" },
  { text: "اگه روز اول دادی ولنتین بشی — دستِ خودته", icon: "skull", color: "#f472b6" },
  { text: "رأی دادی به شهروند؟ مافیا ازت ممنونه", icon: "bomb", color: "#ff6b6b" },
  { text: "چشاتو باز کن. نه اونقدر که مشکوک به‌نظر برسی", icon: "eye", color: "#38bdf8" },
  { text: "ناتو کشیدی؟ یه شات داری، خراب نکن", icon: "knife", color: "#fbbf24" },
  { text: "هر بار اشتباه میکنی مافیا یه نفر میریزه", icon: "fire", color: "#f87171" },
  { text: "اگه اعتماد داری به همه — خوش به حالت", icon: "ghost", color: "#94a3b8" },
  { text: "شهروند ساده‌ای؟ پس سخت‌ترین نقشو داری", icon: "brain", color: "#c084fc" },
  { text: "قرار نیست همه رو قانع کنی — فقط اکثریتو", icon: "clock", color: "#fb923c" },
];
...
const MAFIA_TEXTS = [
  ...
  // --- 25 تای جدید ---
  { text: "روز اول آروم باش. شب کارتو بکن", icon: "clock", color: "#f97316" },
  { text: "اگه از یارت دفاع کردی — بدرود", icon: "skull", color: "#ff6b6b" },
  { text: "خیلی زود بیگناهی ثابت نکن — مشکوکه", icon: "eye", color: "#ffa502" },
  { text: "اگه کارآگاه ازت استعلام گرفت — برنامه داشته باش", icon: "knife", color: "#ef4444" },
  { text: "شب که شات میزنی به دکتر فکر کن", icon: "brain", color: "#c084fc" },
  { text: "یارت لو رفت؟ تو هنوز سالمی. استفاده کن", icon: "fire", color: "#ff4757" },
  { text: "بهترین مافیا اونیه که کسی بهش فکر نمیکنه", icon: "mask", color: "#f97316" },
  { text: "اگه موقع اشتباه خندیدی — همون لحظه‌ایه", icon: "bomb", color: "#ff6b6b" },
  { text: "دوتا رأی بده به شهروند — یکم قانع‌کننده‌تره", icon: "star", color: "#fbbf24" },
  { text: "اگه لو رفتی حداقل یه نفرو باخودت ببر", icon: "lightning", color: "#ffa502" },
  { text: "شهروندا دارن مشورت میکنن. تو هم مشورت کن", icon: "ghost", color: "#c084fc" },
  { text: "شب که دکتر سیو کرد، هدفتو عوض کن", icon: "knife", color: "#ef4444" },
  { text: "رأی خوردی؟ دفاع کن مثل یه شهروند واقعی. هستی که", icon: "shield", color: "#ff6b6b" },
  { text: "خیلی زیاد حرف نزن، خیلی هم کم. معمارِ تعادل باش", icon: "brain", color: "#f97316" },
  { text: "اگه همه بهت اعتماد کردن — فرصت طلاییه، نریزی", icon: "star", color: "#fbbf24" },
  { text: "اون که زودتر از همه میگه «من شهروندم» — باید بپرسی چرا", icon: "eye", color: "#ffa502" },
  { text: "شب که همه چشاشونو بستن — کارت شروع میشه", icon: "skull", color: "#ff6b6b" },
  { text: "جو که علیهته بزن زیر میز — بعد فکر کن", icon: "mask", color: "#c084fc" },
  { text: "یارت داره آبرو میبره. چیکار کنی؟ هیچی. بشین", icon: "ghost", color: "#f97316" },
  { text: "قرار نیست زیرک‌ترین نفر باشی — فقط آخرین", icon: "clock", color: "#fbbf24" },
  { text: "اگه کارآگاه زنده موند — امشب اولویته", icon: "fire", color: "#ff4757" },
  { text: "آروم بخند. نه عصبی، نه بی‌دلیل — درست مثل بازیگر", icon: "mask", color: "#ef4444" },
  { text: "تبریک، عضو بهترین تیمی که احتمالاً بازنده میشه", icon: "bomb", color: "#ff6b6b" },
  { text: "اگه روز آخر موندی — داری خوب بازی میکنی یا فراموشت کردن؟", icon: "brain", color: "#c084fc" },
  { text: "شهروند دوست دارنت. همین الان. فردا ببینیم", icon: "star", color: "#ffa502" },
];
