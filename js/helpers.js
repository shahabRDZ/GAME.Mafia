...
// ── Country & City Data ──
const _COUNTRIES = [
  { v:'ایران',      f:'🇮🇷' }, { v:'ترکیه',      f:'🇹🇷' }, { v:'امارات',    f:'🇦🇪' },
  { v:'آلمان',      f:'🇩🇪' }, { v:'کانادا',      f:'🇨🇦' }, { v:'آمریکا',    f:'🇺🇸' },
  { v:'انگلیس',     f:'🇬🇧' }, { v:'فرانسه',      f:'🇫🇷' }, { v:'هلند',      f:'🇳🇱' },
  { v:'سوئد',       f:'🇸🇪' }, { v:'نروژ',        f:'🇳🇴' }, { v:'دانمارک',   f:'🇩🇰' },
  { v:'فنلاند',     f:'🇫🇮' }, { v:'اتریش',       f:'🇦🇹' }, { v:'سوئیس',     f:'🇨🇭' },
  { v:'بلژیک',      f:'🇧🇪' }, { v:'ایتالیا',     f:'🇮🇹' }, { v:'اسپانیا',   f:'🇪🇸' },
  { v:'پرتغال',     f:'🇵🇹' }, { v:'یونان',       f:'🇬🇷' }, { v:'لهستان',    f:'🇵🇱' },
  { v:'چک',         f:'🇨🇿' }, { v:'مجارستان',    f:'🇭🇺' }, { v:'رومانی',    f:'🇷🇴' },
  { v:'استرالیا',   f:'🇦🇺' }, { v:'نیوزلند',     f:'🇳🇿' }, { v:'ژاپن',      f:'🇯🇵' },
  { v:'کره جنوبی',  f:'🇰🇷' }, { v:'مالزی',       f:'🇲🇾' }, { v:'سنگاپور',   f:'🇸🇬' },
  { v:'قطر',        f:'🇶🇦' }, { v:'کویت',        f:'🇰🇼' }, { v:'عربستان',   f:'🇸🇦' },
  { v:'بحرین',      f:'🇧🇭' }, { v:'عراق',        f:'🇮🇶' }, { v:'افغانستان', f:'🇦🇫' },
  { v:'تاجیکستان',  f:'🇹🇯' }, { v:'آذربایجان',   f:'🇦🇿' }, { v:'ارمنستان',  f:'🇦🇲' },
  { v:'گرجستان',    f:'🇬🇪' }, { v:'روسیه',       f:'🇷🇺' }, { v:'اوکراین',   f:'🇺🇦' },
  { v:'ازبکستان',   f:'🇺🇿' }, { v:'قزاقستان',    f:'🇰🇿' },
];

const _CITIES = {
  'ایران': [
    'تهران','مشهد','اصفهان','شیراز','تبریز','کرج','اهواز','قم','کرمانشاه','ارومیه',
    'رشت','زاهدان','کرمان','همدان','یزد','اردبیل','بندرعباس','قزوین','زنجان','سنندج',
    'ساری','گرگان','بابل','بوشهر','خرم‌آباد','ایلام','شهرکرد','بیرجند','سمنان',
    'مازندران','گیلان','خوزستان','فارس','لرستان','گلستان','مرکزی','البرز','خراسان',
    'آمل','بابلسر','نوشهر','چالوس','رامسر','لاهیجان','انزلی','آستارا','تالش',
    'شاهرود','دامغان','شاهین‌شهر','نجف‌آباد','کاشان','خمین','اراک','بروجرد',
    'دزفول','شوشتر','آبادان','خرمشهر','بهبهان','ماهشهر',
  ],
  'ترکیه': ['استانبول','آنکارا','ازمیر','بورسا','آنتالیا','آدانا','کونیا','غازی‌عنتاب','ترابوزان','ارزروم'],
  'امارات': ['دبی','ابوظبی','شارجه','عجمان','راس الخیمه','فجیره'],
  'آلمان': ['برلین','مونیخ','هامبورگ','فرانکفورت','کلن','اشتوتگارت','دوسلدورف','لایپزیگ'],
  'کانادا': ['تورنتو','ونکوور','مونترال','کالگاری','اوتاوا','ادمونتون','وینیپگ'],
  'آمریکا': ['نیویورک','لس‌آنجلس','شیکاگو','هیوستون','واشنگتن','فونیکس','فیلادلفیا','سانفرانسیسکو'],
  'انگلیس': ['لندن','منچستر','برمنگام','لیدز','گلاسگو','ادینبورا','لیورپول'],
  'فرانسه': ['پاریس','مارسی','لیون','تولوز','نیس','نانت','استراسبورگ'],
  'آذربایجان': ['باکو','گنجه','سومقایت','لنکران','شکی','قبله'],
  'گرجستان': ['تبیلیسی','باتومی','کوتایسی','رستوی'],
  'ارمنستان': ['ایروان','گیومری','وانادزور'],
  'عراق': ['بغداد','بصره','موصل','اربیل','کربلا','نجف','سلیمانیه'],
  'افغانستان': ['کابل','هرات','مزار شریف','قندهار','جلال‌آباد'],
  'استرالیا': ['سیدنی','ملبورن','بریزبن','پرت','آدلاید','کانبرا'],
  'قطر': ['دوحه','الریان','الوکره'],
  'عربستان': ['ریاض','جده','مکه','مدینه','دمام'],
  'سوئد': ['استکهلم','گوتنبرگ','مالمو','اوپسالا'],
  'هلند': ['آمستردام','روتردام','لاهه','اوترخت'],
  'اتریش': ['وین','گراتس','لینتس','زالتزبورگ','اینسبروک'],
};

function _populateCountries(selectEl, withAll = false) {
  if (!selectEl) return;
  let html = withAll ? '<option value="">همه کشورها</option>' : '';
  html += _COUNTRIES.map(c => `<option value="${c.v}">${c.f} ${c.v}</option>`).join('');
  selectEl.innerHTML = html;
}

function _onCountryChange(selectEl, cityInputId) {
  const country = selectEl.value;
  const cityInput = document.getElementById(cityInputId);
  if (!cityInput) return;

  // Find linked datalist
  const dlId = cityInput.getAttribute('list');
  const dl = dlId ? document.getElementById(dlId) : null;
  if (!dl) return;

  const cities = _CITIES[country] || [];
  dl.innerHTML = cities.map(c => `<option value="${c}">`).join('');
  cityInput.placeholder = country === 'ایران' ? 'شهر (مثلاً تهران)' : 'شهر...';
  cityInput.value = '';
  cityInput.focus();
}

function _initEventSelects() {
  _populateCountries(document.getElementById('eventCountryFilter'), true);
  _populateCountries(document.getElementById('evCountry'), false);
}
