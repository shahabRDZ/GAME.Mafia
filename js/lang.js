...
const LANG = {
  fa: {
    ...
    roles: {
      ...
      "جاماسب": "جاماسب", "کاوه": "کاوه", "رستم": "رستم", "آرش کمانگیر": "آرش کمانگیر", "یار": "یار"
    }
  },
  en: {
    dir: "ltr",
    ...
    roles: {
      ...
      "جاماسب": "Jamasp", "کاوه": "Kaveh", "رستم": "Rostam", "آرش کمانگیر": "Arash the Archer", "یار": "Yar"
    }
  },
  tr: {
    dir: "ltr",
    ...
    roles: {
      ...
      "جاماسب": "Jamasp", "کاوه": "Kave", "رستم": "Rüstem", "آرش کمانگیر": "Okçu Araş", "یار": "Yar"
    }
  }
};
